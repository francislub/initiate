...
export default function TopBar() {
  return (
    <div className="w-full bg-black text-white py-2 md:py-0">
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center text-sm">
        <div className="flex flex-col md:flex-row items-center md:space-x-6 mb-2 md:mb-0">
          <div className="flex items-center space-x-2 mb-2 md:mb-0">
            <Mail className="h-4 w-4" />
            <Link href="mailto:info@girlupuganda.org" className="hover:text-gray-300 transition-colors">
        ...
        <div className="flex items-center space-x-4 flex-wrap justify-center">
          <div className="flex space-x-4">
            <Link href="https://www.facebook.com/profile.php?id=61565856121815" className="hover:text-gray-300 transition-colors">
